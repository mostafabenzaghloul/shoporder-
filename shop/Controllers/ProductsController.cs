...
namespace shop.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        private readonly IProductsServices _moviesService;
        private readonly ICategoriesServices _genresService;

        private new List<string> _allowedExtenstions = new List<string> { ".jpg", ".png" };
        private long _maxAllowedPosterSize = 1048576;

        public ProductsController(IProductsServices moviesService, ICategoriesServices genresService, IMapper mapper)
        {
        ...
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            ...
            var dto = _mapper.Map<ProductDetailsDto>(movie);
        ...
        public async Task<IActionResult> CreateAsync([FromForm] ProductDto dto)
        {
            ...
            var isValidGenre = await _genresService.IsvalidGenre(dto.CategoryId);
            ...
            var movie = _mapper.Map<Product>(dto);
        ...
        public async Task<IActionResult> UpdateAsync(int id, [FromForm] ProductDto dto)
        {
            ...
            movie.Descreption = dto.Descreption;
            movie.Rate = dto.Rate;
